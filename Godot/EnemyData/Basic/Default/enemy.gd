...
@onready var enemy_aggro_state = $FiniteStateMachine/EnemyAggroState
@onready var enemy_wander_state = $FiniteStateMachine/enemy_wander_state
@onready var enemy_attack_state = $FiniteStateMachine/enemy_attack_state
@onready var enemy_damaged_state = $FiniteStateMachine/enemy_damaged_state
